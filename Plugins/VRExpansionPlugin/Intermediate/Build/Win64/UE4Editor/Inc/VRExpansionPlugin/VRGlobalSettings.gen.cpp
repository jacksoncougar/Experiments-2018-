...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFAxisMappingDetails
{
	...
	void UVRGlobalSettings::StaticRegisterNativesUVRGlobalSettings()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AddControllerProfile", (Native)&UVRGlobalSettings::execAddControllerProfile },
			{ "AdjustTransformByControllerProfile", (Native)&UVRGlobalSettings::execAdjustTransformByControllerProfile },
			{ "DeleteControllerProfile", (Native)&UVRGlobalSettings::execDeleteControllerProfile },
			{ "GetControllerProfile", (Native)&UVRGlobalSettings::execGetControllerProfile },
			{ "GetControllerProfiles", (Native)&UVRGlobalSettings::execGetControllerProfiles },
			{ "GetCurrentProfile", (Native)&UVRGlobalSettings::execGetCurrentProfile },
			{ "LoadControllerProfile", (Native)&UVRGlobalSettings::execLoadControllerProfile },
			{ "LoadControllerProfileByName", (Native)&UVRGlobalSettings::execLoadControllerProfileByName },
			{ "OverwriteControllerProfile", (Native)&UVRGlobalSettings::execOverwriteControllerProfile },
			{ "SaveControllerProfiles", (Native)&UVRGlobalSettings::execSaveControllerProfiles },
		};
