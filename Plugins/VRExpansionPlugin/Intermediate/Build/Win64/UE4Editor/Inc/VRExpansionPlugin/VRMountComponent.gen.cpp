...
// End Cross Module References
	...
	void UVRMountComponent::StaticRegisterNativesUVRMountComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AdvancedGripSettings", (Native)&UVRMountComponent::execAdvancedGripSettings },
			{ "ClosestGripSlotInRange", (Native)&UVRMountComponent::execClosestGripSlotInRange },
			{ "DenyGripping", (Native)&UVRMountComponent::execDenyGripping },
			{ "GetGripStiffnessAndDamping", (Native)&UVRMountComponent::execGetGripStiffnessAndDamping },
			{ "GetInteractionSettings", (Native)&UVRMountComponent::execGetInteractionSettings },
			{ "GetPrimaryGripType", (Native)&UVRMountComponent::execGetPrimaryGripType },
			{ "GripBreakDistance", (Native)&UVRMountComponent::execGripBreakDistance },
			{ "GripLateUpdateSetting", (Native)&UVRMountComponent::execGripLateUpdateSetting },
			{ "GripMovementReplicationType", (Native)&UVRMountComponent::execGripMovementReplicationType },
			{ "IsHeld", (Native)&UVRMountComponent::execIsHeld },
			{ "IsInteractible", (Native)&UVRMountComponent::execIsInteractible },
			{ "OnChildGrip", (Native)&UVRMountComponent::execOnChildGrip },
			{ "OnChildGripRelease", (Native)&UVRMountComponent::execOnChildGripRelease },
			{ "OnEndSecondaryUsed", (Native)&UVRMountComponent::execOnEndSecondaryUsed },
			{ "OnEndUsed", (Native)&UVRMountComponent::execOnEndUsed },
			{ "OnGrip", (Native)&UVRMountComponent::execOnGrip },
			{ "OnGripRelease", (Native)&UVRMountComponent::execOnGripRelease },
			{ "OnInput", (Native)&UVRMountComponent::execOnInput },
			{ "OnSecondaryGrip", (Native)&UVRMountComponent::execOnSecondaryGrip },
			{ "OnSecondaryGripRelease", (Native)&UVRMountComponent::execOnSecondaryGripRelease },
			{ "OnSecondaryUsed", (Native)&UVRMountComponent::execOnSecondaryUsed },
			{ "OnUsed", (Native)&UVRMountComponent::execOnUsed },
			{ "ResetInitialMountLocation", (Native)&UVRMountComponent::execResetInitialMountLocation },
			{ "SecondaryGripType", (Native)&UVRMountComponent::execSecondaryGripType },
			{ "SetHeld", (Native)&UVRMountComponent::execSetHeld },
			{ "SimulateOnDrop", (Native)&UVRMountComponent::execSimulateOnDrop },
			{ "TeleportBehavior", (Native)&UVRMountComponent::execTeleportBehavior },
			{ "TickGrip", (Native)&UVRMountComponent::execTickGrip },
		};
	...
	IMPLEMENT_CLASS(UVRMountComponent, 3170223641);
